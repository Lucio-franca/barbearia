...
export default function CancelScreen() {
  ...
  useEffect(() => {
    async function fetchAgendamento() {
      ...
      if (data.cancelado) { setStatus("already"); return; }
    ...
    >
      ...
      <div id="ss-container">
        ...
        >
          ...
          {/* CARREGANDO */}
          {status === "loading" && (
            <p style={{ color: "#aaa", fontFamily: "Oswald", letterSpacing: 2, fontSize: 14 }}>
              Carregando...
            </p>
          )}
          ...
          {status === "found" && agendamento && (
            <>
              <div className="confirm-rows" style={{ width: "100%", marginBottom: 8 }}>
                {[
